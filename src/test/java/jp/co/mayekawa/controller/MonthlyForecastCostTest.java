...
public class MonthlyForecastCostTest {
    ...
    void selectMonthlyForecastCost_ReturnsCorrectData() throws Exception {
        ...
        mockMvc.perform(post("/monthly/search").contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON).content(requestJson)).andDo(print()).andExpect(status().isOk())
